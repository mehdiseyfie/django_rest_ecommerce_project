...
DATABASES = {
    'default': env.db('DATABASE_URL', default='psql://mehdiseyfi:1441clock@M@127.0.0.1:5432/django_rest_ecommerce_project'),
}
...
REST_FRAMEWORK = {
    ...
    # 'EXCEPTION_HANDLER': 'django_rest_ecommerce_project.api.exception_handlers.hacksoft_proposed_exception_handler',
