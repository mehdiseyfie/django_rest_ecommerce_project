...
from django_rest_ecommerce_project.cart.apis import CartApi, CartItemApi, CartItemDetailApi, CartClearApi, CartTotalsApi
...
urlpatterns = [
    ...
    path("cart-totals/", CartTotalsApi.as_view(), name="cart_totals"),
